#!/bin/bash
export LD_LIBRARY_PATH="$LD_LIBRARY_PATH:/home/ogp_agent/OGP_User_Files/rustDev/RustDedicated_Data/Plugins/x86_64"
while true ; do
  ...
  ./RustDedicated -batchmode +rcon.web 1 +rcon.port 28116 +rcon.password randomPassword1258 -logfile output.txt
  done
