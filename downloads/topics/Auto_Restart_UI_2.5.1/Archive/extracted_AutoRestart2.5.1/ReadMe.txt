...
2. Edit the Config file as needed with the UI. /crestart
3. Edit the Language file as needed
4. Reload the plugin

For Help and Support, Please add me on Discord.
...
This License Agreement ("Agreement") is made and entered into between crash ("Licensor") and the individual or entity that has obtained a copy of the Rust plugin ("Licensee").
