...
WPKits addon has been rewritten, config/data file has changed.
This is not mandatory update, you can keep using 1.2.4 version or lower if you like to. 

Before installing new version make sure you have latest version of WelcomePanel, also detele your old WPKits config file. 
